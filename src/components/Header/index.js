...
const Header = () => (
  <nav className="nav-header">
    <div className="nav-content">
      <p className="website-logo">ND</p>
      <ul className="nav-menu">
        <li>
          <a href="https://www.linkedin.com/in/dileep-kumar-nagam/">
            <img
        ...
        <li>
          <a href="https://github.com/dileepnagam">
            <img
              className="social-network-img"
        ...
        <li>
          <a href="https://twitter.com/NagamDileep">
            <img
              className="social-network-img"
